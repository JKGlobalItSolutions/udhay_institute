...
<main>
  <div className="bread">
    ...
    >
      <h2 className="container-fluid">Workshops for Various Programs</h2>
      <ol className="breadcrumb container">
        <li className="breadcrumb-item"><a href="../index.html">Home</a></li>
        <li className="breadcrumb-item active" aria-current="page">Workshops for Various Programs</li>
      </ol>
    </nav>
  </div>
  ...
  <div className="container mt-4">
    <div className="maincontent">
      ...
      <div className="orderedlist p-2">
        ...
        <ul className="p-2">
          <li>
            Participate in interactive workshops focused on enhancing essential skills such as communication, problem-solving, teamwork, leadership,
            and critical thinking, all of which are crucial for success in today's workplace.
          </li>
        </ul>
        ...
        <ul className="p-2">
          <li>
            Learn practical skills and techniques relevant to your field of study through specialized workshops covering topics such as programming,
            digital marketing, graphic design, robotics, and more.
          </li>
        </ul>
        ...
        <ul className="p-2">
          <li>
            Receive guidance on resume writing, interview preparation, networking, and career planning to help you navigate the job market
...
export default Workshop_for_various_programs